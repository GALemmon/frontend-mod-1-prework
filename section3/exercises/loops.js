...
// The numerical value of 'i' is displayed as it has 1 added to it each time it goes through the loop.  By putting
// 'i' in the parenthesis, you are telling the computer to display the value assigned to the variable.
